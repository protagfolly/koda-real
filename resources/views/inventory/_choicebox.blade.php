<li class="list-group-item">
    ...
    <div id="openChoiceBoxForm" class="collapse">
        ...
        <p>This item has a selection of prizes inside, but you can only choose one! Please note that you can only select one choice each time you open this box, so if you have multiple and want different choices, you should open them one at a time.
            This action is not reversible. Are you sure you want to open this box?</p>
        @php
