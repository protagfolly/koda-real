...
@section('admin-content')
    ...
    <p>Page Categories must be put into Page Sections to be displayed in the encyclopedia. A section is an index page that lists pages by category within it. For example, one can make a Lore section and Guides section, and then create "history" and
        "deities" categories in Lore and "Prompt Guide" and "Beginners Materials" categories for Guides.
